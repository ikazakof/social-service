...
public class CommentCommentNotificationHandler implements NotificationHandler {
    ...
    public List<UserNotification> fillReceiverIds(UserNotification userNotification) {
        ...
        if (settingsRepository.findByUserId(userNotification.getReceiverId()).orElseThrow().getCommentComment())
    ...
    public NotificationType myType() {
        return NotificationType.COMMENT_COMMENT;
    }
}
